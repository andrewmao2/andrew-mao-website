                ...
                <div className="contact__info">
                    ...
                    <div className="contact__card">
                        ...
                        <h3 className="contact__card-title">Call Me</h3>
                            <span className="contact__card-data">770-828-5893</span>

                            <a href="tel:7708285893" className="contact__button">Write me {""}
                            <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
            ...
            <div className="contact__content">
                ...
                <form ref={form} onSubmit={sendEmail} className="contact__form">
                    ...
                    <div className="contact__form-div contact__form-area">
                        ...
                        className="contact__form-input" placeholder="write your message here"></textarea>
                    </div>
