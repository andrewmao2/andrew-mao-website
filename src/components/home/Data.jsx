...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Andrew Mao
        <svg
            width="36"
            height="36"
            viewBox="0 0 48 48"
        ...
        <p className="home__description">
            ...
            Georgia Institute of Technology specializing in Human Computer Interaction & Front-End Technologies 
            along with a certificate from the Scheller College of Business in Leadership and Organizational Behavior!
